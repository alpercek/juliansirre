...
<template>
  ...
  <div id="enlarge" class="hidden"><div class="fixed inset-0 bg-white opacity-60" onclick="this.parentElement.style.display = 'none'" ></div><video src="" onclick="this.play()" class="opacity-100 w-[500px] fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"> </div>
